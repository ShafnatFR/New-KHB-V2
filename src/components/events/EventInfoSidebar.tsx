...
import { Calendar, Clock, MapPin, Users, UserCheck, CalendarPlus, Share2, ChevronDown } from "lucide-react";
        ...
        <div className="space-y-3">
          {isCompleted ? (
            ...
            <a 
              ...
              className="w-full bg-primary text-white py-4 rounded-2xl font-bold flex items-center justify-center gap-3 shadow-lg shadow-primary/20 hover:bg-primary-dark transition-all text-sm"
            >
              <UserCheck size={18} />
              Daftar Sekarang
            </a>
